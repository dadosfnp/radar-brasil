...
| 2026-09-09 | pendente  | Metodologia mobile: toque/swipe nas fotos — tap/swipe-left avanca foto; swipe-right volta; ciclo entre 4 fotos via display:block/none |
| 2026-09-09 | pendente  | Painel Multinivel mobile v17: min-width:0 corrige overflow das celulas waffle — containers flex nao mais se expandem alem do card |
| 2026-09-09 | pendente  | Avaliacao Painel modal mobile v14: inset:88px_0_0 no overlay inicia modal geometricamente abaixo do header (substituindo padding-top) |
| 2026-09-09 | (HEAD)    | Header logos alinhados: Radar Brasil igualado ao FNP em todos os breakpoints (desktop 62px, 1280 50px, 1024 44px, mobile 36px); pill position:absolute top:100% margin-top:4px; padding header-top 6px/36px simetrico (base.css v17) |
...
| 2026-09-17 | (HEAD)    | Sobre (sobre.css v10): redesign do Fact Sheet para fidelidade ao design Visme de referencia -- sb-info-dark-zone (header+colunas fundo navy #101d4f), sb-info-orb (circulo 58px border-radius:50% fundo semitransparente branco, icone SVG branco), texto das colunas branco/rgba(255,255,255,.82), bolhas direitas navy escuro #172c62 com texto branco, sb-info-factors fundo #101d4f com sb-info-factors-pill (#1e3575 arredondado), sb-info-factors-chevrons (dois chevrons CSS diagonais cor rgba(165,195,230,.70)), sb-info-factors-list items brancos, sb-info-right fundo #c8d8ea, grafico horseshoe 270 graus com rotate(135) |
| 2026-09-18 | (HEAD)    | Sobre (sobre.css v12): reconstrucao completa seguindo design system -- paleta #1f3350/#3c4d6b/#4a5b78/#a9c1e0/#cfdcef; header navy-700 com padding-bottom 80px; circulos brancos 72px sobrepostos margin-top -44px; cards navy-900 com ::before tail apontando para cima; eval fundo #cfdcef; steps com badge navy sobrepos pill navy-900; highlight fundo navy-900 com pill #cfdcef texto dark; chevrons U+2304 empilhados em #a9c1e0 |
| 2026-09-18 | (HEAD)    | Sobre (sobre.css v13): redesign total com design system do usuario -- duas fact-sheets empilhadas (594x820px e 583x772px); paleta navy #161c4e / slate #536084 / blue #adc6e5; Sheet01-hero: 3 info-cards com round-icon 90px + card-body pill border-radius:62px absolutamente posicionados; gauge semicirculo conic-gradient com ::after furo branco (substitui SVG horseshoe); Sheet01-evaluation: speech-bubble arredondado #adc6e5 + speech-tail triangulo CSS; Sheet02: method-pills staircase com pill-label circulo slate; factor-title #adc6e5 com ::before/::after cantos navy recortados; chevrons duplos via border-right+border-bottom+rotate(45deg) |
| 2026-09-18 | (HEAD)    | Sobre (sobre.css v14): 5 ajustes finos -- card-01 avatar-principal.svg (56px); card-body top:64px+min-height:248px (fix corte); conic-gradient reescrito para 180deg visiveis (58.8/33.1/33.1/55.1 graus, 4 cores); speech-tail apontando para baixo; pills top:64/150/236px (fix corte); factor-title::before/::after movidos para o TOPO (abaulados superiores) |
| 2026-09-18 | (HEAD)    | Sobre (sobre.css v11): segunda rodada de fidelidade ao design de referencia -- sb-info-callout (speech bubble em #c0d8f0 com triangulo CSS ::after apontando para o grafico), sb-info-chevron refeito com ::before/::after de barras anguladas formando V real (rotate 35deg), sb-info-factors-pill em #3558a0 (azul medio visivelmente mais claro que fundo #0f1c47), sb-info-right background #d4e5f5, orb 64px, texto das colunas text-align justify |
| 2026-09-23 | (pendente)| Componentes/Avaliacao Painel (avaliacao-painel.css v15): fix modal ficha tecnica -- .ap-modal-overlay z-index 1000 era menor que .rb-header-wrapper (1001), header sticky cobria o cabecalho do modal (titulo/PDF/X) ao rolar a pagina; corrigido para z-index 1100 |
| 2026-09-23 | (pendente)| Header Global (base.css v19): fix menu quebrando linha em notebooks -- com fonte cheia os 7 itens so cabiam numa linha a partir de ~1570px; breakpoints 1280/1024px encolhiam fonte mas nao eram suficientes, menu quebrava em 2-3 linhas entre ~769-1565px; breakpoint do hamburger estendido de 768px para 1600px (acima disso menu em linha, abaixo colapsa para dropdown, nunca mais quebra); testado com Playwright em 16 larguras (375-1920px) -- **REVERTIDO na entrada seguinte, ver v20** |
| 2026-09-23 | (pendente)| Header Global (base.css v20): revisao do fix acima apos feedback do usuario ("desktop tem que ficar desktop, nao hamburger") -- hamburger em 1600px revertido; nova abordagem com 6 degraus de encolhimento fluido (fonte 1.051rem->0.625rem, padding 18px->5px, logo Radar 74px->42px, logo FNP 62px->34px nos breakpoints 1600/1440/1300/1180/1080/980px) mantem o menu completo em uma linha ate 920px; hamburger so entra abaixo de 900px (janela estreita/tablet, nao notebook real); degraus encontrados empiricamente com Playwright headless, testado em 31 larguras incluindo todas resolucoes comuns de notebook |
| 2026-09-23 | (pendente)| Landing (landing.css v13): fix chips do card "Knowledge in Action" quebrando linha em EN -- "Dashboards"+"Maps"+"Data" ultrapassavam a largura do card por poucos pixels (cabia em PT com "Painéis"/"Mapas"/"Dados"); .lp-info-chip padding reduzido de 3px 10px para 3px 8px (minimo medido com Playwright: 9px), + white-space:nowrap |
| 2026-09-23 | (pendente)| Sobre (sobre.css v25): fix legenda do gauge descentralizada -- animation fs-up (v23) sobrescrevia o transform:translateX(-50%) de centralizacao da .legend com translateY, perdendo o -50% em X permanentemente (fill-mode:both); nova keyframe fs-up-centered reafirma translateX(-50%) em todo frame; testado com Playwright headless (centro legenda == centro sheet) |
| 2026-09-23 | (pendente)| Sobre (sobre.css v24): fix overflow horizontal fantasma -- .fact-sheets full-bleed escalado 1.4x criava caixa invisivel maior que a viewport, gerando scrollbar horizontal na pagina sem conteudo visivel; corrigido com overflow-x:hidden em .sb-infographic; confirmado via Playwright (scrollWidth == innerWidth) |
